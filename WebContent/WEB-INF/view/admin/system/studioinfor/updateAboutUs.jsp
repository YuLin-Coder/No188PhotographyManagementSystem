...
<form class="layui-form layui-row" id="infoForm">
    ...
    <label class="layui-form-label" style="width:100px;">关于我们：</label>    
  	</div>
	<textarea id="editor" name="aboutUs" style="width:1024px;height:500px;" lay-verify="aboutUs">${studioinfor.aboutUs}</textarea>
	<div class="layui-form-item">
