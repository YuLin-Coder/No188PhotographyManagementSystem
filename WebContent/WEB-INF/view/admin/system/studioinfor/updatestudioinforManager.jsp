...
<form class="layui-form layui-row" id="infoForm">
    ...
    <label class="layui-form-label" style="width:100px;">工作室简介：</label>    
  	</div>
	<textarea id="editor" name="studIntroduction" style="width:1024px;height:500px;" lay-verify="studIntroduction">${studioinfor.studIntroduction}</textarea>
	<div class="layui-form-item">
