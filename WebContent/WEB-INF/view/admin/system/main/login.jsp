...
<body class="loginBody">
	<form class="layui-form" id="loginFrm" method="post" action="${ctx }/login/adminLogin">
		<div class="login_face"><img src="${ctx}/resources/images/logo.jpg" class="userAvatar"></div>
